...
namespace ChatGpt {
    public class ChatGptPlugin : MpIAnalyzeComponentAsync, MpISupportHeadlessAnalyzerComponentFormat {
                ...
                using (var request = new HttpRequestMessage(
                    ...
                    try {
                        ...
                        if (http_response.IsSuccessStatusCode) {
                            var opai_resp = JsonSerializer.Deserialize<ChatGptResponse>(http_response_str);
